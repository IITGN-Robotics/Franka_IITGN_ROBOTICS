...
class CartesianControllerFront : public controller_interface::MultiInterfaceController<
...
public:
  bool init(hardware_interface::RobotHW* robot_hardware, ros::NodeHandle& node_handle) override
  {
    ...
    {
      ROS_ERROR("CartesianControllerFront: Could not get Cartesian Pose interface from hardware");
      return false;
    }
    ...
    {
      ROS_ERROR("CartesianControllerFront: Could not get parameter arm_id");
      return false;
    }
    ...
    {
      ROS_ERROR_STREAM("CartesianControllerFront: Exception getting Cartesian handle: " << e.what());
      return false;
    }
    ...
    {
      ROS_ERROR("CartesianControllerFront: Could not get state interface from hardware");
      return false;
    }
    ...
    {
      ROS_ERROR_STREAM("CartesianControllerFront: Exception getting state handle: " << e.what());
      return false;
    }
  ...
  void starting(const ros::Time& /*time*/) override
  {
    ...
    ROS_INFO("CartesianControllerFront: Holding for 5 seconds before moving 5 cm front.");
  }
  ...
  void update(const ros::Time& /*time*/, const ros::Duration& period) override
  {
    ...
    if (t >= 1.0 && !reached_target_)
    {
      ...
      ROS_INFO("CartesianControllerFront: Reached target pose (5 cm front).");
    }
  }
  
  ~CartesianControllerFront() override {}
...
PLUGINLIB_EXPORT_CLASS(franka_iitgn::CartesianControllerFront, controller_interface::ControllerBase)
...
//     reached_target_ = false;
//     ROS_INFO("CartesianControllerFront: Starting move 5 cm front.");
//   }
...
//     // Smooth interpolation using a cosine profile.
